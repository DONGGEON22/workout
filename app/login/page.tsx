...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto flex min-h-dvh max-w-sm flex-col justify-center px-6 py-12">
      ...
      <h1 className="mt-1.5 text-2xl font-semibold tracking-tight text-stone-900">로그인</h1>
      <p className="mt-1.5 text-sm text-stone-500">이름과 숫자 4자리로 시작하세요</p>
      ...
      <p className="mt-8 text-center text-sm text-stone-500">
        처음이신가요?{" "}
        <Link href="/register" className="font-semibold text-indigo-600 underline decoration-indigo-200 underline-offset-4">
          가입하기
        </Link>
      </p>
    </div>
